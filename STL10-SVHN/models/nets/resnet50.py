...
class ResNet50(nn.Module):
    ...
    def __init__(
        ...
        if need_head_aux:
            self.head_aux = nn.Sequential(
                ...
                nn.Linear(128 * block.expansion, n_class),
            )
    ...
    def _forward_impl(self, x, need_head_aux=False):
    ...
    def forward(self, x, need_head_aux=False):
        return self._forward_impl(x, need_head_aux)


class build_ResNet50:
    def __init__(self, is_remix=False, need_head_aux=False):
        self.is_remix = is_remix
        self.need_head_aux = need_head_aux

    def build(self, num_classes):
        model = ResNet50(n_class=num_classes, is_remix=self.is_remix, need_head_aux=self.need_head_aux)
        return model
